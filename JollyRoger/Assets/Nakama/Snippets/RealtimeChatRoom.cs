...
namespace Nakama.Snippets
{
    public class RealtimeChatRoom : MonoBehaviour
    {
        ...
        private readonly IClient _client = new Client("http", "192.168.99.100", 7350, "defaultkey", UnityWebRequestAdapter.Instance);
#else
        private readonly IClient _client = new Client("http", "192.168.99.100", 7350, "defaultkey");
#endif
...
#if UNITY_WEBGL && !UNITY_EDITOR
            var deviceId = "2729f5b647dc7d83d8b90e77aafb6048ac980e4a";
#else
